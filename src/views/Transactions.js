...
function Transactions() {
  ...
  // if(myData===null){
  //   marketPlace.methods.getCountOfPurchases().call({from: account.current}).then(function(){
  //     marketPlace.methods.getPurchases().call({from: account.current}).then(function(){
